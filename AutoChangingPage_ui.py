...
"background: transparent;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 954, 281))
        ...
        self.ChosePath_2 = PushButton(self.SimpleCardWidget_3)
        self.ChosePath_2.setObjectName(u"ChosePath_2")
        self.ChosePath_2.setMinimumSize(QSize(128, 0))

        self.horizontalLayout_6.addWidget(self.ChosePath_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.ChosePath_2.setText(QCoreApplication.translate("Form", u"\u653e\u5f03\u66f4\u6539", None))

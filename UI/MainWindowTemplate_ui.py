...
from PySide6.QtWidgets import (QApplication, QSizePolicy, QVBoxLayout, QWidget, QFrame)

from qfluentwidgets import (PopUpAniStackedWidget, Pivot, SegmentedWidget, SingleDirectionScrollArea)
...
"background: transparent;")
        ...
        self.SingleDirectionScrollArea.setMaximumHeight(40)
        self.SingleDirectionScrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1034, 69))
        self.scrollAreaWidgetContents.setMaximumHeight(33)
...
"}")
        ...
        self.OpacityAniStackedWidget = PopUpAniStackedWidget(Form)

...
class Ui_Form(QDialog):
    def __init__(self, title, content, TrueText, FalseText, Editable, dark=False):
        super().__init__()
        #super().__init__()
        self.title = f"{title}"
...
"}")
        ...
        self.BodyLabel.setAlignment(Qt.AlignmentFlag.AlignJustify|Qt.AlignmentFlag.AlignTop)

...
"border: none;")
        ...
        self.verticalSpacer_21 = QSpacerItem(10, 8, QSizePolicy.Minimum, QSizePolicy.Fixed)
        ...
        self.verticalSpacer_22 = QSpacerItem(10, 18, QSizePolicy.Minimum, QSizePolicy.Fixed)

        # self.verticalLayout_2.addItem(self.verticalSpacer_22)
        ...
        self.verticalSpacer_9 = QSpacerItem(20, 20, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.MinimumExpanding)
...
"}")
        ...
        self.ElevatedCardWidget_3 = CardWidget(self.widget)
    ...
    def retranslateUi(self, Form):
        ...
        self.PushButton.setText(QCoreApplication.translate("Form", u"\u8bbe\u7f6e\u4e3a \u81ea\u52a8\u66f4\u6362\u58c1\u7eb8", None))

        __sortingEnabled = self.Images_Indicator.isSortingEnabled()
        self.Images_Indicator.setSortingEnabled(False)
        ___qlistwidgetitem = self.Images_Indicator.item(0)

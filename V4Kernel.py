...
from qfluentwidgets import (BodyLabel, CardWidget, CheckBox, ComboBox,
                            CommandBar, CommandBarView, DisplayLabel, DoubleSpinBox, ElevatedCardWidget, FluentIcon, FlyoutAnimationManager, FlyoutViewBase, HorizontalFlipView,
...
class AdEnginePage(QWebEnginePage):
    def acceptNavigationRequest(self, url, _navigation_type, is_main_frame):
        if url.scheme() in ["http", "https"]:
            web.open(str(url.toString()))  # 使用系统默认浏览器打开链接
            return False  # 阻止在当前视图中打开
        return True

class AdsEngine(QWebEngineView):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setPage(AdEnginePage(self))
...
class Ui_Form(object):
    ...
    def change_background(self):
        self.pixmap = QPixmap('./BACKIMG1.png')  # <---------------背景图片
        ...
        scaled_width = int(self.pixmap.width() * (scaled_height / self.pixmap.height()))

        # 缩放图片
        self.pixmap = self.pixmap.scaled(scaled_width, scaled_height,
                               Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)

        # 创建一个 QPalette 对象，并设置背景图片
        palette = QPalette()
        palette.setBrush(QPalette.Window, QBrush(QPixmap(self.pixmap)))
    ...
    def setupUi(self, Form: QWidget):
        ...
        self.MainUI.setWindowTitle("壁纸生成器 4.1")
        ...
        self.gridLayout_2.addWidget(self.ACGKind, 8, 1, 1, 3)
        ...
        self.gridLayout_2.addItem(self.verticalSpacer_8, 13, 2, 1, 1)

        self.verticalSpacer_11 = QSpacerItem(20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_2.addItem(self.verticalSpacer_11, 4, 0, 1, 1)
        ...
        self.StrongBodyLabel_17 = StrongBodyLabel(self.scrollAreaWidgetContents)
        ...
        font3.setBold(False)
        self.StrongBodyLabel_17.setFont(font3)

        self.gridLayout_2.addWidget(self.StrongBodyLabel_17, 5, 0, 1, 1)

        self.verticalSpacer_6 = QSpacerItem(
            20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_2.addItem(self.verticalSpacer_6, 9, 0, 1, 1)

        self.ACGSource = ComboBox(self.scrollAreaWidgetContents)
        self.ACGSource.setObjectName(u"ACGSource")
        self.ACGSource.setStyleSheet(u"ComboBox {\n"
"    border: 1px solid rgba(0, 0, 0, 0.073);\n"
"    border-radius: 5px;\n"
"    border-bottom: 1px solid rgba(0, 0, 0, 0.183);\n"
"    padding: 5px 31px 6px 11px;\n"
...
"}\n"
"")
        self.ACGSource.setFlat(False)
        self.ACGSource.currentIndexChanged.connect(self.ACGSourceChanged)

        self.ACGSource.clear()
        self.ACGSource.addItem("MirlKoi（默认）")
        self.ACGSource.addItem("Loliapi")
        self.ACGSource.addItem("帮助我选择一个来源")
        self.ACGSource.setCurrentIndex(0)

        self.gridLayout_2.addWidget(self.ACGSource, 5, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.ACGProgress, 16, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.ACGStart, 14, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.ACGSlider, 12, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.ACGNumber, 10, 3, 1, 1)
        ...
        self.gridLayout_2.addItem(self.verticalSpacer_21, 15, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.StrongBodyLabel_2, 10, 0, 1, 3)

        self.StrongBodyLabel = StrongBodyLabel(self.scrollAreaWidgetContents)
        self.StrongBodyLabel.setObjectName(u"StrongBodyLabel")
        self.StrongBodyLabel.setFont(font3)

        self.gridLayout_2.addWidget(self.StrongBodyLabel, 8, 0, 1, 1)

        self.verticalSpacer_9 = QSpacerItem(
            20, 20, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout_2.addItem(self.verticalSpacer_9, 17, 0, 1, 1)
        ...
        self.verticalLayout_4.addWidget(self.widget_7)
         ...
         # 创建 QWebEngineView
        # self.ACGbrowser = AdsEngine(self)
        # self.verticalLayout_4.addWidget(self.ACGbrowser)
        ...
        # self.Pixivbrowser = AdsEngine(self)
        # self.verticalLayout_6.addWidget(self.Pixivbrowser)
        ...
        self.SimpleCardWidget_4.setMinimumSize(QSize(400, 0))
        ...
        self.gridLayout_9.setContentsMargins(5, 0, 15, 0)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_7, 14, 1, 1, 1)

        self.verticalSpacer_39 = QSpacerItem(
            20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_9.addItem(self.verticalSpacer_39, 28, 1, 1, 1)

        self.verticalSpacer_38 = QSpacerItem(
            20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_9.addItem(self.verticalSpacer_38, 17, 1, 1, 1)

        self.verticalSpacer_32 = QSpacerItem(
            20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_9.addItem(self.verticalSpacer_32, 7, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.AISteps, 14, 3, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.AIObey, 19, 3, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.AIStart, 29, 1, 1, 3)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_9, 10, 1, 1, 3)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_12, 21, 1, 1, 2)

        self.verticalSpacer_40 = QSpacerItem(
            20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_9.addItem(self.verticalSpacer_40, 22, 1, 1, 1)

        self.ChooseGoodTags = PushButton(self.scrollAreaWidgetContents_3)
        self.ChooseGoodTags.setObjectName(u"ChooseGoodTags")
        self.ChooseGoodTags.clicked.connect(self.SelectAITags)

        self.gridLayout_9.addWidget(self.ChooseGoodTags, 6, 1, 1, 3)
        ...
        self.gridLayout_9.addItem(self.verticalSpacer_33, 20, 2, 1, 1)

        self.verticalSpacer_30 = QSpacerItem(
            20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_9.addItem(self.verticalSpacer_30, 13, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_6, 24, 1, 1, 3)
        ...
        self.gridLayout_9.addWidget(self.AIBadTags, 11, 1, 1, 3)
        ...
        self.gridLayout_9.addWidget(self.AISize, 16, 3, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_13, 25, 1, 1, 3)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_10, 16, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_11, 19, 1, 1, 2)

        self.verticalSpacer_35 = QSpacerItem(
            10, 10, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_9.addItem(self.verticalSpacer_35, 30, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_15, 27, 1, 1, 3)
        ...
        self.gridLayout_9.addWidget(self.AIFix, 21, 3, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_14, 26, 1, 1, 3)

        self.verticalSpacer_31 = QSpacerItem(
            20, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_9.addItem(self.verticalSpacer_31, 15, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.StrongBodyLabel_16, 23, 1, 1, 3)
        ...
        # self.AIbrowser = AdsEngine(self)
        # self.verticalLayout_8.addWidget(self.AIbrowser)
        ...
        self.gridLayout_6.addItem(self.verticalSpacer_23, 17, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.UserAgency, 16, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.InsiderAgency, 12, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.SubtitleLabel_4, 11, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.NoAgency, 15, 1, 1, 1)
        ...
        self.gridLayout_6.addItem(self.verticalSpacer_25, 23, 6, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.SaveSettings, 21, 6, 1, 1)
        ...
        self.ChoseBackgroundPath.clicked.connect(self.choose_background)

        self.gridLayout_6.addWidget(self.ChoseBackgroundPath, 8, 6, 1, 1)
        
        self.verticalSpacer_26 = QSpacerItem(
            10, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_6.addItem(self.verticalSpacer_26, 21, 7, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.UserInputAgency, 16, 2, 1, 5)

        self.SubtitleLabel_7 = SubtitleLabel(self.SimpleCardWidget_3)
        self.SubtitleLabel_7.setObjectName(u"SubtitleLabel_7")

        self.gridLayout_6.addWidget(self.SubtitleLabel_7, 8, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.AboutButton, 21, 1, 1, 1)
        ...
        self.ACGSource.setDefault(True)
    ...
    def retranslateUi(self, Form):
        ...
        self.StrongBodyLabel.setText(QCoreApplication.translate(
            "Form", u"\u7b5b\u9009\u7c7b\u578b\uff1a", None))
        self.StrongBodyLabel_17.setText(QCoreApplication.translate("Form", u"\u751f\u6210\u6765\u6e90\uff1a", None))
        ...
        self.ChooseGoodTags.setText(QCoreApplication.translate("Form", u"\u6253\u5f00\u6807\u7b7e\u9009\u53d6\u5668", None))
...
#         <html>
#         <body>
#         <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8725158711685943"
#      crossorigin="anonymous"></script>
# <ins class="adsbygoogle"
#      style="display:block"
#      data-ad-format="fluid"
#      data-ad-layout-key="-fb+5w+4e-db+86"
#      data-ad-client="ca-pub-8725158711685943"
#      data-ad-slot="6431695953"></ins>
# <script>
...
#         </html>
#         """
        # self.ACGbrowser.setHtml(ads_code)
        # self.Pixivbrowser.setHtml(ads_code)
        # self.AIbrowser.setHtml(ads_code)

        file_path = os.path.abspath("donate.html") 
        # self.ACGbrowser.setUrl(QUrl.fromLocalFile(file_path)) 
        # self.Pixivbrowser.setUrl(QUrl.fromLocalFile(file_path)) 
        # self.AIbrowser.setUrl(QUrl.fromLocalFile(file_path)) 
    ...
    def choose_background(self):
        new_path, _  = QFileDialog.getOpenFileName(
            self, '生成的图片将会保存在：', "", "BACKIMG1.png (*.png)")
        if new_path:
            shutil.copyfile(new_path, "BACKIMG1.png")
            self.change_background()
            self.update_background()
# ———————————————————————————————————————
# ————————————Interaction-ACG————————————
# ———————————————————————————————————————
    ...
    def ACGSourceChanged(self):
        print("ACG Source help {}".format(self.ACGSource.currentIndex()))
        if self.ACGSource.currentIndex() == 2:
            if self.ACGNumber.isEnabled():
                self.ACGSource.setCurrentIndex(0)
            else:
                self.ACGSource.setCurrentIndex(1)

            help_text = '''1. Miklroi：拥有更多的图片分类，如白毛、兽娘、星空等，也可以筛选生成适合不同设备尺寸的壁纸。生成速度极快，但少数时候可能会掉线。
2. Loliapi：图片分类较少，但能生成ACG头像。稳定性相对更好，生成速度相对较慢。
当生成出现网络问题或其他位置问题时，切换来源可以很大程度上解决问题。'''
            BatchWindow = QDialog()
            ui1 = DialogUi.Ui_Form("如何选择 ACG 图片来源", help_text, "好的", "取消", "True")
            ui1.setupUi(BatchWindow)
            BatchWindow.exec_()
        elif self.ACGSource.currentIndex() == 1:
            self.ACGContentKind.setEnabled(False)
            self.ACGDevicesKind.setEnabled(False)
            self.ACGNumber.setValue(1)
            self.ACGSlider.setValue(1)
            self.ACGNumber.setEnabled(False)
            self.ACGSlider.setEnabled(False)

            self.ACGKind.clear()
            self.ACGKind.addItem("随机壁纸")
            self.ACGKind.addItem("随机头像")
            self.ACGKind.addItem("电脑壁纸")
            self.ACGKind.addItem("手机壁纸")
            self.ACGKind.setCurrentIndex(0)
        else:
            self.ACGContentKind.setEnabled(True)
            self.ACGDevicesKind.setEnabled(True)
            self.ACGNumber.setEnabled(True)
            self.ACGSlider.setEnabled(True)

            if self.ACGContentKind.isChecked():
                self.ACGKind.clear()
                self.ACGKind.addItem("随机")
                self.ACGKind.addItem("精选")
                self.ACGKind.addItem("白毛")
    ...
    def ACGloliapi_downloader(self, api, saved_filename, result: queue.Queue):
        print("loliapi start download")
        try:
            output = requests.get(api).content
            save = os.path.join(
    ...
    # "border: none;")
            ...
            if self.ACGSource.currentIndex() == 1:
                ...
                thread = threading.Thread(
                        target=self.ACGloliapi_downloader, args=(api, saved_filename, result))
                thread.start()

                while self.completed_threads < 1:
                    QtCore.QCoreApplication.processEvents()

                thread.join()

                ability, infor = result.get()
                print(infor)
                print(ability)
                if infor != 0:
                    print("Failed")
...
'''
    ...
    def PixivshowDialog(self):
        title = '思锐工作室《壁纸生成器》系列产品用户须知和免责声明'
        content = """请所有用户在使用本产品前务必认真仔细阅读。使用本产品即代表您同意本声明。

1. 知识产权声明
本软件依赖于 Loliapi API、Miklroi API、Lolicon API 等其他免费接口，开源项目或免费许可使用模型，完全遵循其免费使用协议或开源协议。部分生成的图片来源于网络搜集，由其作者保留所有权利，本软件只负责展示和合法传播。如为AI生成的图片，其权利归属由生成该图片的模型提供商的相关规定决定。

2. 商业用途限制
所有本产品相关的内容及所生成的任何图片均不可以用于任何商业用途。用户在使用本产品期间，不得有违反本软件的开源协议及软件中所使用到的免费接口，开源项目或免费许可使用模型的开源协议和免费使用协议的行为，违者任何后果自负。如有图片作者认为本系列产品侵犯其正当权益，请与接口提供商和开源项目负责人联系和交涉，思锐工作室不对此承担责任。

3. 内容来源及规范性
本产品所生成的任何图片资源均来源于第三方接口、开源项目和图片生成模型，由其提供商通过搜集网络图片资源或生成图片并返回给本产品。若部分图片内容存在违规现象，可以联系我们进行相关功能的整改或者下线。思锐工作室不对生成的图片内容承担任何责任。

4. 法律遵守
所有用户须遵守以上须知并严格遵守中华人民共和国法律，不得利用本产品进行任何非法活动或侵犯他人权利的行为。

5. 图片处理责任
本产品仅供学习交流和娱乐使用，用户应当在生成和保存图片后于24小时内删除，且对保存的图片及其使用承担全部法律责任。

6. 变更通知
若本声明的内容有任何变更，恕我们不另行通知，请用户每次更新本产品后及时阅读本声明以获得最新信息。

7. 投诉与反馈
如用户认为其权益受到侵害，应及时与思锐工作室联系进行反馈，思锐工作室将尽快处理此类投诉。
...
# ———————————————————————————————————————
    ...
    def SelectAITags(self):
        file_path = os.path.abspath('./TagsSelector/index.html')
        web.open(file_path)
    ...
    def GetAIFailed(self, em):
        ...
        try:
            match e:
                ...
                case "o":
                    raise OverflowError("溢出错误")
                case "j":
                    raise requests.exceptions.JSONDecodeError("解码错误", "内容", 0)  # 实例化对象
                case "k":
                    raise KeyError("键错误")
                case "e":
                    raise Exception("一般错误")
            ...
            FlowTip.create(
                icon=InfoBarIcon.ERROR,
                title=f'我们这边出了错',
                content=f"请稍后再试，或与我们的开发者反馈这个问题。",
                target=self.AIStart,
                parent=self,
                isClosable=True,
            ...
            msg_box.setWindowTitle("由于遇到错误，壁纸生成停止")
            msg_box.setText(
                f"由于一个意外的 {type(e)} 错误，无法继续生成壁纸。可将以下详细信息截图并反馈：\n\n" + em[1])
            msg_box.setIcon(QMessageBox.Icon.Critical)
            msg_box.setStandardButtons(QMessageBox.StandardButton.Ok)
            msg_box.show()
            msg_box.exec()
